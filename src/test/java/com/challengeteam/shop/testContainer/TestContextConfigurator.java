...
public class TestContextConfigurator {
    ...
    // STRIPE
    public final static String DEFAULT_STRIPE_PUBLIC_KEY = "pk_test_51SrH0wKB02ZfQRuGJHLBv2LZ3wtl6izuVsXkBbtY9vyVgi3LQsRbAeR3oopfOLWUq6QKm4OmuHCiiRNSvnObaeG600TBtCpdCT";
    public final static String DEFAULT_STRIPE_PRIVATE_KEY = "sk_test_51SrH0wKB02ZfQRuG051jK3M8vMJUpQksOCwofuBHItJUCpA1YplsKAUzF3RHcz1Aaa12JAbb0gwxlDG5eb6IHPaI002XmIEXr6";
    public final static String DEFAULT_STRIPE_PAYMENT_SUCCESS_URL = "https://conlang.org/cms/wp-content/uploads/Paymentsuccessful21.png";
    public final static String DEFAULT_STRIPE_WEBHOOK_SECRET = "whsec_d5f287e6da7f75dde76d4df1a94dd92a79a5f7aaf9d356cc42afa1276e7c8b5c";        // MUST BE INSERTED MANUALLY
    public final static String DEFAULT_STRIPE_CHECKOUT_EXPIRATION_TIME = "1800";
    ...
    private static void configureDefaultContext(DynamicPropertyRegistry propertyRegistry) {
        ...
        propertyRegistry.add("payment.stripe.public-key", () -> DEFAULT_STRIPE_PUBLIC_KEY);
        propertyRegistry.add("payment.stripe.private-key", () -> DEFAULT_STRIPE_PRIVATE_KEY);
        propertyRegistry.add("payment.stripe.payment-success-url", () -> DEFAULT_STRIPE_PAYMENT_SUCCESS_URL);
        propertyRegistry.add("payment.stripe.webhook-secret", () -> DEFAULT_STRIPE_WEBHOOK_SECRET);
        propertyRegistry.add("payment.stripe.checkout-expiration-time", () -> DEFAULT_STRIPE_CHECKOUT_EXPIRATION_TIME);
    }
