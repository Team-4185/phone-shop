...
public class TestContextConfigurator {
    ...
    public final static String DEFAULT_JWT_RESET_SECRET = "test-reset-secret-key-that-is-long-enough-32chars";
    public final static String DEFAULT_JWT_ACCESS_TOKEN_EXPIRATION = "10m";
    public final static String DEFAULT_JWT_REFRESH_TOKEN_EXPIRATION = "20m";
    public final static String DEFAULT_JWT_REMEMBER_ME_REFRESH_TOKEN_EXPIRATION = "30m";
    public final static String DEFAULT_JWT_RESET_TOKEN_EXPIRATION = "15m";
    ...
    public final static String DEFAULT_MAIL_HOST = "localhost";
    public final static String DEFAULT_MAIL_PORT = "25";
    public final static String DEFAULT_MAIL_USERNAME = "test@gmail.com";
    public final static String DEFAULT_MAIL_PASSWORD = "test-password";
    public final static String DEFAULT_FRONTEND_URL = "https://example.com";
    ...
    private static void configureDefaultContext(DynamicPropertyRegistry propertyRegistry) {
        ...
        propertyRegistry.add("security.jwt.remember-me-refresh-token-expiration", () -> DEFAULT_JWT_REMEMBER_ME_REFRESH_TOKEN_EXPIRATION);
        propertyRegistry.add("security.jwt.reset-token-expiration", () -> DEFAULT_JWT_RESET_TOKEN_EXPIRATION);
        ...
        propertyRegistry.add("spring.mail.host", () -> DEFAULT_MAIL_HOST);
        propertyRegistry.add("spring.mail.port", () -> DEFAULT_MAIL_PORT);
        propertyRegistry.add("spring.mail.username", () -> DEFAULT_MAIL_USERNAME);
        propertyRegistry.add("spring.mail.password", () -> DEFAULT_MAIL_PASSWORD);
        propertyRegistry.add("security.frontend-url", () -> DEFAULT_FRONTEND_URL);
    }
