...
class PhoneFilteringAndSortingServiceTest {
    ...
    static void init() {
        listOfPhonesWithPriceLowerThan300 = List.of(
                new PhoneResponseDto(1L, "Samsung Galaxy A14", "Budget smartphone", new BigDecimal("299.99"), samsungBrand, 2023, "Exynos 850", 8, "6.6\"", "13MP", "50MP", "5000mAh", List.of()),
                new PhoneResponseDto(2L, "Nokia G22", "Affordable phone", new BigDecimal("199.99"), nokiaBrand, 2023, "Unisoc T606", 8, "6.5\"", "8MP", "50MP", "5050mAh", List.of()),
                new PhoneResponseDto(3L, "Motorola Moto G13", "Entry-level device", new BigDecimal("179.99"), motorolaBrand, 2023, "MediaTek Helio G85", 8, "6.5\"", "8MP", "50MP", "5000mAh", List.of())
        );
        listOfPhonesWithPriceGreater300 = List.of(
                new PhoneResponseDto(4L, "Google Pixel 7a", "Mid-range phone", new BigDecimal("500.99"), googleBrand, 2023, "Google Tensor G2", 8, "6.1\"", "13MP", "64MP", "4385mAh", List.of()),
                new PhoneResponseDto(5L, "Samsung Galaxy A54", "Mid-tier device", new BigDecimal("449.99"), samsungBrand, 2023, "Exynos 1380", 8, "6.4\"", "32MP", "50MP", "5000mAh", List.of()),
                new PhoneResponseDto(6L, "OnePlus Nord N30", "Good value phone", new BigDecimal("399.99"), onePlusBrand, 2023, "Snapdragon 695", 8, "6.72\"", "16MP", "108MP", "5000mAh", List.of()),
                new PhoneResponseDto(7L, "Xiaomi Redmi Note 12", "Budget-friendly", new BigDecimal("349.99"), xiaomiBrand, 2023, "Snapdragon 685", 8, "6.67\"", "13MP", "50MP", "5000mAh", List.of())
        );
        listOfPhonesWithPriceLower1000AndPriceHigherThan500 = List.of(
                new PhoneResponseDto(8L, "iPhone 14", "Apple flagship", new BigDecimal("799.99"), appleBrand, 2022, "A15 Bionic", 6, "6.1\"", "12MP", "12MP", "3279mAh", List.of()),
                new PhoneResponseDto(9L, "Samsung Galaxy S23", "Premium Android", new BigDecimal("899.99"), samsungBrand, 2023, "Snapdragon 8 Gen 2", 8, "6.1\"", "12MP", "50MP", "3900mAh", List.of()),
                new PhoneResponseDto(10L, "Google Pixel 8", "Latest Pixel", new BigDecimal("699.99"), googleBrand, 2023, "Google Tensor G3", 8, "6.2\"", "10.5MP", "50MP", "4575mAh", List.of()),
                new PhoneResponseDto(11L, "OnePlus 11", "Flagship killer", new BigDecimal("699.99"), onePlusBrand, 2023, "Snapdragon 8 Gen 2", 8, "6.7\"", "16MP", "50MP", "5000mAh", List.of()),
                new PhoneResponseDto(12L, "Xiaomi 13", "Premium phone", new BigDecimal("749.99"), xiaomiBrand, 2023, "Snapdragon 8 Gen 2", 8, "6.36\"", "32MP", "50MP", "4500mAh", List.of())
        );
        listOfApplePhonesBrand = List.of(
                new PhoneResponseDto(13L, "Apple iPhone 13", "Previous gen iPhone", new BigDecimal("599.99"), appleBrand, 2021, "A15 Bionic", 6, "6.1\"", "12MP", "12MP", "3240mAh", List.of()),
                new PhoneResponseDto(14L, "Apple iPhone 14 Pro", "Pro model", new BigDecimal("999.99"), appleBrand, 2022, "A16 Bionic", 6, "6.1\"", "12MP", "48MP", "3200mAh", List.of()),
                new PhoneResponseDto(15L, "Apple iPhone SE", "Compact iPhone", new BigDecimal("429.99"), appleBrand, 2022, "A15 Bionic", 6, "4.7\"", "7MP", "12MP", "2018mAh", List.of())
        );
        listOfPhonesWithMultipleBrands = List.of(
                new PhoneResponseDto(16L, "Samsung Galaxy Z Fold 5", "Foldable phone", new BigDecimal("1799.99"), samsungBrand, 2023, "Snapdragon 8 Gen 2", 8, "7.6\"", "10MP", "50MP", "4400mAh", List.of()),
                new PhoneResponseDto(17L, "Google Pixel Fold", "Google's foldable", new BigDecimal("1799.99"), googleBrand, 2023, "Google Tensor G2", 8, "7.6\"", "9.5MP", "48MP", "4821mAh", List.of()),
                new PhoneResponseDto(18L, "OnePlus Open", "OnePlus foldable", new BigDecimal("1699.99"), onePlusBrand, 2023, "Snapdragon 8 Gen 2", 8, "7.82\"", "32MP", "48MP", "4805mAh", List.of()),
                new PhoneResponseDto(19L, "Motorola Razr 40", "Flip phone", new BigDecimal("699.99"), motorolaBrand, 2023, "Snapdragon 7 Gen 1", 8, "6.9\"", "32MP", "64MP", "4200mAh", List.of())
        );
        listOfPhonesWithStockIn = List.of(
                new PhoneResponseDto(20L, "Samsung Galaxy S23 Ultra", "In stock flagship", new BigDecimal("1199.99"), samsungBrand, 2023, "Snapdragon 8 Gen 2", 8, "6.8\"", "12MP", "200MP", "5000mAh", List.of()),
                new PhoneResponseDto(21L, "iPhone 15", "Available now", new BigDecimal("799.99"), appleBrand, 2023, "A16 Bionic", 6, "6.1\"", "12MP", "48MP", "3349mAh", List.of()),
                new PhoneResponseDto(22L, "Google Pixel 8 Pro", "Ready to ship", new BigDecimal("999.99"), googleBrand, 2023, "Google Tensor G3", 8, "6.7\"", "10.5MP", "50MP", "5050mAh", List.of()),
                new PhoneResponseDto(23L, "Xiaomi 13 Pro", "In stock", new BigDecimal("999.99"), xiaomiBrand, 2023, "Snapdragon 8 Gen 2", 8, "6.73\"", "32MP", "50MP", "4820mAh", List.of())
        );
        listOfPhonesWithPreOrder = List.of(
                new PhoneResponseDto(24L, "Samsung Galaxy S24", "Pre-order available", new BigDecimal("899.99"), samsungBrand, 2024, "Snapdragon 8 Gen 3", 8, "6.2\"", "12MP", "50MP", "4000mAh", List.of()),
                new PhoneResponseDto(25L, "iPhone 15 Pro Max", "Coming soon", new BigDecimal("1199.99"), appleBrand, 2023, "A17 Pro", 6, "6.7\"", "12MP", "48MP", "4422mAh", List.of()),
                new PhoneResponseDto(26L, "OnePlus 12", "Pre-order now", new BigDecimal("799.99"), onePlusBrand, 2024, "Snapdragon 8 Gen 3", 8, "6.82\"", "32MP", "50MP", "5400mAh", List.of())
        );
