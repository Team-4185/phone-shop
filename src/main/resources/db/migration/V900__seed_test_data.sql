...
(1, 1, 1, 'iPhone 15 Pro', 'APL-IP15P-001', 999.99, 'BLACK', 'CAPACITY_128GB', 1, 999.99,
 NOW() - INTERVAL '30 days', NULL),
-- order 2: Samsung Galaxy A55 x1
(2, 2, 7, 'Samsung Galaxy A55', 'SAM-A55-001', 449.99, 'GOLD', 'CAPACITY_512GB', 1, 449.99,
...
(4, 4, 2, 'iPhone 15', 'APL-IP15-001', 799.99, 'GOLD', 'CAPACITY_64GB', 1, 799.99,
...
(6, 6, 10, 'Google Pixel 8 Pro', 'GOO-P8P-001', 999.99, 'GRAY', 'CAPACITY_512GB', 1, 999.99,
 NOW() - INTERVAL '3 days', NULL),
(7, 6, 14, 'Xiaomi 14', 'XIA-14-001', 699.99, 'BLACK', 'CAPACITY_256GB', 1, 699.99,
 NOW() - INTERVAL '3 days', NULL),
-- order 7: Sony Xperia 5 V x1
(8, 7, 19, 'Sony Xperia 5 V', 'SON-X5V-001', 599.99, 'WHITE', 'CAPACITY_512GB', 1, 599.99,
...
(10, 9, 18, 'Sony Xperia 1 VI', 'SON-X1VI-001', 1299.99, 'GRAY', 'CAPACITY_2TB', 1, 1299.99,
 NOW() - INTERVAL '2 days', NULL),
-- order 10: Samsung Galaxy S24 x1
(11, 10, 6, 'Samsung Galaxy S24', 'SAM-S24-001', 699.99, 'GRAY', 'CAPACITY_256GB', 1, 699.99, NOW(), NULL)
ON CONFLICT (id) DO NOTHING;
-- set sequences
