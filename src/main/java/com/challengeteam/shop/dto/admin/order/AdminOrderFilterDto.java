...
public record AdminOrderFilterDto(
    ...
    @Pattern(
            regexp =
                "createdAt_asc|createdAt_desc|total_asc|total_desc|status_asc|status_desc|customerEmail_asc|customerEmail_desc|id_asc|id_desc",
            message =
                "Sort must be one of: createdAt_asc, createdAt_desc, total_asc, total_desc, status_asc, status_desc, customerEmail_asc, customerEmail_desc, id_asc, id_desc")
        String sort) {
